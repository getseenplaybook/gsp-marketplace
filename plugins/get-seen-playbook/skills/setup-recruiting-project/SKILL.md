...
- If I ask for any change to an email or a shell, even when I approve it with a change, make the change and show me the whole updated email or shell again. Create the Gmail draft only after I approve that exact version.
